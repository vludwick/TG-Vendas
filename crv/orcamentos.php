    ...
    <div class="container">
        ...
        <div class="row" id="clienteprocura" style="margin-top: 45px;">
            ...
            <div class="col-md-4 offset-md-0">
                <div class="row my-1">
                    <input  style="margin-left: 50px; margin-top: -40px" class="form-control cpfOuCnpj" type="form-control" id="buscacliente" name="buscacliente" placeholder="CPF ou CNPJ do Cliente" autocomplete="off">
                </div>
            </div> 
        </div>
    </div>
