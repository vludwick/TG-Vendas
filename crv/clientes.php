...
<html>
         ...
         <table class="table table-hover table-striped table-bordered" id="cliente">
            ...
            <tbody>
               <?php
                  ...
                  ?>
               <td><a href="#edita" data-toggle="modal" data-target="#cadastroCliente"><i class="fas fa-edit"></a></td>
   ...
   <!-- Formulário para envio da ação e do ID para o modal em caso de Edição -->
	<form action="clientes.php" method="POST">
		<input type="text" id="id" name="id" value="">
	    <input type="text" id="acao" name="acao" value="">
